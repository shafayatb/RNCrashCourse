...
export const deletePosts = async (videoPost) => {
    try {
        await Promise.all([
            storage.deleteFile(
                storageId,
                videoPost.thumbnailID
            ),
            storage.deleteFile(
                storageId,
                videoPost.videoFileID
            )
        ]);
...
export const bookmarkPosts = async (bookmarked, videoPostId, user) => {
    try {
